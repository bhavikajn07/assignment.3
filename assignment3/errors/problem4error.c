...
extern float companyProfit; // missing definition
...
int main()
{
    ...
    printf("Profit = %.2f\n", companyProfit); // undefined variable

    generateReport(); // undefined function

    displayEmployee(); // undefined function

    processData(); // undefined function

    saveRecord(); // undefined function

    loadRecord(); // undefined function

    printInvoice(); // undefined function

    calculateTax(); // undefined function

    validateUser(); // undefined function

    sendNotification(); // undefined function

    generateCertificate(); // undefined function
